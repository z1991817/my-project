...
async function createImageGenerationRecordsTable() {
  try {
    console.log('开始创建图片生成记录表...\n');
    ...
    console.log('✅ 图片生成记录表创建成功');

    console.log('\n✅ 表创建完成！');
    console.log('   支持的生成类型: text-to-image, image-to-image');
    console.log('   关联用户表: users');
...
createImageGenerationRecordsTable();
